...
<form action="" method="post">
    <label><b class="modalText">E-mail</b></label><input type="" placeholder="Entrez votre adresse mail" name="mail" required>
    <br />
    ...
    <br />
    <label><b class="modalText">Confirmer le mot de passe</b></label><input type="password" placeholder="Réécrivez le mot de passe" name="password2" required>
    <br />
